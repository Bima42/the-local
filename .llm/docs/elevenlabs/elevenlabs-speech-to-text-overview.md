...
<CardGroup cols={2} rows={2}>
  <Card title={<div className="flex items-start gap-2"><div>Eleven v3</div><div><img src="file:afbb64e0-00ba-47ef-a52b-412449fac240" alt="Alpha" /></div></div>} href="/docs/overview/models#eleven-v3-alpha">
...
<CardGroup cols={2} rows={1}>
  <Card title="Scribe v2" href="/docs/overview/models#scribe-v2">
    ...
    <div className="mt-4 space-y-2">
      ...
      <div className="text-sm">Speaker diarization, up to 32 speakers</div>
...
<Frame background="subtle">
  <img
    src="file:2512a68b-b992-45bb-94c1-baf3ecca5e89"
